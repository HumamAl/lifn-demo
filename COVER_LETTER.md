...
Your core constraint — the UI must never directly call external APIs, every intent routes through a centralized dispatcher — I built a working version of this before reaching out: https://lifn-demo.vercel.app
